...
<head>
  ...
  <title>Pustaka | Perpustakaan Digital</title>
</head>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="100">
  ...
  <nav class="site-nav dark mb-5 site-navbar-target">
    <div class="container">
      <div class="site-navigation">
        <a href="index.html" class="logo m-0">e-perpustakaan<span class="text-primary">.</span></a>
        ...
        <ul class="js-clone-nav d-none d-lg-inline-none site-menu float-right site-nav-wrap">
          ...
          <li><a href="<?php echo e(URL::to("register")); ?>" class="nav-link">Register</a></li>
          <li><a href="<?php echo e(URL::to("login")); ?>" class="nav-link">Login</a></li>
        </ul>
  ...
  <div class="untree_co-section pb-0" id="home-section">
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          <h3 class="heading gsap-reveal-hero mb-3"><strong>Perpustakaan Digital<span class="text-primary"></span> Laravel</strong></h3>
          <h2 class="subheading gsap-reveal-hero mb-4">
            Perpustakaan Digital adalah Halaman Informasi tentang ilmu pengetahuan<strong></strong>. Baca Selengkapnya <a href="https://untree.co/license" target="_blank">template license</a> here.
          </h2>
  ...
  <div class="untree_co-section untree_co-section-4 pb-0"  id="portfolio-section">
        ...
        <div id="posts" class="row">
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-1.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="1">
              ...
              <img src="<?php echo e(asset("images/img_1.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-2.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="2">
              ...
              <img src="<?php echo e(asset("images/img_2.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_3.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_4.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_5.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-1.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="1">
              ...
              <img src="<?php echo e(asset("images/img_6.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-2.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="2">
              ...
              <img src="<?php echo e(asset("images/img_7.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_8.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_9.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_11.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
          ...
          <div class="item web branding col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
            <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="3">
              ...
              <img src="<?php echo e(asset("images/img_12.jpg")); ?>" class="lazyload  img-fluid" alt="Images" />
            </a>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-3">
          <div class="col-lg-7 mx-auto text-center author-wrap">
            <img src="<?php echo e(asset("images/person_1.jpg")); ?>" alt="Image" class="img-fluid rounded-circle mb-3">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="service text-center">
              <div class="gsap-reveal-hero mb-3">
                <span class="icon-service"><img src="<?php echo e(asset("images/svg/service-icon-7.svg")); ?>" alt="Image" class="img-fluid"></span>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="service text-center">
              <div class="gsap-reveal-hero mb-3">
                <span class="icon-service"><img src="<?php echo e(asset("images/svg/service-icon-6.svg")); ?>" alt="Image" class="img-fluid"></span>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="service text-center">
              <div class="gsap-reveal-hero mb-3">
                <span class="icon-service"><img src="<?php echo e(asset("images/svg/service-icon-1.svg")); ?>" alt="Image" class="img-fluid"></span>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="service text-center">
              <div class="gsap-reveal-hero mb-3">
                <span class="icon-service"><img src="<?php echo e(asset("images/svg/service-icon-8.svg")); ?>" alt="Image" class="img-fluid"></span>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="service text-center">
              <div class="gsap-reveal-hero mb-3">
                <span class="icon-service"><img src="<?php echo e(asset("images/svg/service-icon-4.svg")); ?>" alt="Image" class="img-fluid"></span>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="service text-center">
              <div class="gsap-reveal-hero mb-3">
                <span class="icon-service"><img src="<?php echo e(asset("images/svg/service-icon-5.svg")); ?>" alt="Image" class="img-fluid"></span>
              </div>
          ...
          <div class="owl-carousel owl-3-slider">
            <div class="item">
              <div class="testimonial-v1">
                <img src="<?php echo e(asset("images/person_1.jpg")); ?>" alt="Image" class="img-fluid">
                <div class="mb-4">
                  <h3>James Smith</h3>
            ...
            <div class="item">
              <div class="testimonial-v1">
                <img src="<?php echo e(asset("images/person_2.jpg")); ?>" alt="Image" class="img-fluid">
                <div class="mb-4">
                  <h3>Jenny Wilson</h3>
                  <span class="caption">CEO &amp; Co-Founder</span>
                </div>
            ...
            <div class="item">
              <div class="testimonial-v1">
                <img src="<?php echo e(asset("images/person_3.jpg")); ?>" alt="Image" class="img-fluid">
                <div class="mb-4">
                  <h3>Dan Anderson</h3>
                  <span class="caption">CEO &amp; Co-Founder</span>
                </div>
        ...
        <div class="row">
          <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="0">
            <div class="post-entry">
              <a href="#" class="thumb"><img src="<?php echo e(asset("images/gal_1.jpg")); ?>" alt="image" class="img-fluid"></a>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
            <div class="post-entry">
              <a href="#" class="thumb"><img src="<?php echo e(asset("images/gal_2.jpg")); ?>" alt="image" class="img-fluid"></a>
              <h3><a href="#">Separated they live in</a></h3>
              <div class="post-meta">
                Aug 4, 2020 by <a href="#">Admin</a> in <a href="#">Web Design</a>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
            <div class="post-entry">
              <a href="#" class="thumb"><img src="<?php echo e(asset("images/gal_3.jpg")); ?>" alt="image" class="img-fluid"></a>
              <h3><a href="#">Separated they live in</a></h3>
              <div class="post-meta">
                Aug 4, 2020 by <a href="#">Admin</a> in <a href="#">Web Design</a>
              </div>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
            <div class="post-entry">
              <a href="#" class="thumb"><img src="<?php echo e(asset("images/gal_4.jpg")); ?>" alt="image" class="img-fluid"></a>
              <h3><a href="#">Separated they live in</a></h3>
              <div class="post-meta">
                Aug 4, 2020 by <a href="#">Admin</a> in <a href="#">Web Design</a>
              </div>
    ...
    <script src="<?php echo e(asset("js/wave-animate.js")); ?>"></script>
    ...
    <script src="<?php echo e(asset("js/scrollmagic.animation.gsap.min.js")); ?>"></script>
...
<?php /**PATH D:\laragon\www\perpustakaan\resources\views/front.blade.php ENDPATH**/ ?>